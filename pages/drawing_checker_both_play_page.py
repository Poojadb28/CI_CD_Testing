...
class DrawingCheckerPage(BasePage):
    ...
    option = (
        By.XPATH,
        "//option[normalize-space()='Drawing Checker - Both']"
    )

    run_btn = (
        By.XPATH,
        "//button[contains(text(),'Run Drawing Checker - Both')]"
    )
    ...
    view_details = (
        By.XPATH,
        "//button[normalize-space()='View Details']"
    )
    ...
    report_tab = (
        By.XPATH,
        ".//button[normalize-space()='Drawing Checker - Both']"
    )
    ...
    def select_drawing_checker(self):
        ...
        logger.info(
            "Selecting Drawing Checker - Both"
        )
    ...
    def filter_by_severity(self, severity):
        ...
        option = (
            ...
            (
                ...
                f"/option[normalize-space()='{severity}']"
            )
        )
    ...
    def filter_by_source(self, source):
        ...
        option = (
            ...
            (
                ...
                f"/option[normalize-space()='{source}']"
            )
        )
    ...
    def download_report(self, download_dir):
        ...
        logger.info(
            "Downloading Drawing Checker report"
        )
        ...
        raise Exception(
            "Drawing Checker report download failed"
        )
